...
Safeguards against downloading too much data at once
(both for memory reasons and to avoid the max row limit for the API):
...
Usage:
    1. Get an API key from: https://quickstats.nass.usda.gov/api
